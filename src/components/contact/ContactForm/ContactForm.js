...
function ContactForm() {
  ...
  const renderButton = (executing, isSubmitting) => {
    if (errMsg) {
      return (
        <button className="contact__submit-btn mt-3" type="submit" disabled>
          Error
        </button>
      );
    } else if (msgSent) {
  ...
  return (
    <section>
      <Container id="contact">
        <h2 className="contact__title" ref={contactTitle1Ref}>
          Email
        </h2>
              ...
              >
                {({ resetForm }) => (
                  ...
                  >
                    ...
                    {errMsg ? (
                      <div className="text-primary m-1">{errMsg}</div>
                    ) : null}
                    {(msgSent || errMsg) && (
                      <button
        ...
        <div className="contact__email-container">
          <h2 className="contact__or-title">o</h2>
          <div className="contact__email-txt">
            ...
            <p>
              <a href="mailto:mpg.sebastian@gmail.com" className="g__body-lg">
                mpg.sebastian@gmail.com
              </a>
            </p>
          </div>
        </div>
