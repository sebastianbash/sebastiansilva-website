  ...
  return (
    <nav
      ...
      className={`nav__container ${
        toggleBurgerMenu ? null : "nav__container--mobile"
      }`}
      aria-label="main navigation"
    >
      {/* Mobile Logo */}
      <Link exact="true" to="/" className="nav__logo-container--mobile">
        <Logo cssClass="nav__logo--mobile" animation={logoRef} />
      </Link>
      ...
      <button
        ...
        className={`nav__toggle-btn 
                    ${!toggleBurgerMenu ? "open" : null}`}
      >
        <div className="nav__toggle-btn__burger"></div>
      </button>

      {/* Left Page Link Menu */}
      <ul
        className={`nav__link-container 
                ${toggleBurgerMenu ? null : "open--grid"}`}
        ref={leftLinksRef}
      >
        <li>
          <NavLink
      ...
      {/* Desktop Logo */}
      <Link exact="true" to="/" className="nav__logo-container--desktop">
        <Logo cssClass="nav__logo--desktop" animation={logoRef} />
      </Link>
      ...
      <ul className={`nav__social ${toggleBurgerMenu ? null : "open--grid"}`}>
        <li>
          <a
            className="nav__link"
